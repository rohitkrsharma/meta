          ...
          <div className='space-y-14'>
            <div className='md:flex text-white font-poppins gap-40'>
              ...
              <div className='rounded-xl'>
                <img src='https://metaadfrontend.s3.ap-south-1.amazonaws.com/Banner_Image.jpg' alt='banner' className='rounded-xl w-96' />
              </div>
            </div>
            <div className="flex  items-center">
              <div className="flex gap-5 bg-pink-500 p-5 rounded-3xl h-48 shadow-md ">
                <div className="flex flex-col justify-center items-center font-poppins">
                  <div className='text-white'>
                    ...
                    <button onClick={handleLoginClick} className="flex items-center gap-2 bg-blue-500 text-white px-4 py-2 rounded-md">
                      <img src='./images/butto_icon.png' alt='button' className='w-4' />
                      Login Account
                    </button>
                  </div>
                </div>
                <div className="">
                  <img
                    src="./images/login_as_reseller.png"
                    alt="Card"
